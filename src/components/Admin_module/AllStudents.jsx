...
export default function FullFeaturedCrudGrid() {
  ...
  const fetchStudents = () => {
    axios.get('http://localhost:2001/student/all')
      .then(response => {
  ...
  const handleAddRecord = () => {
    ...
    axios.post('http://localhost:2001/student/addStudent', {
      email: newEmail,
      fullName: fullName,
  ...
  const handleDeleteClick = (email) => () => {
    ...
    if (confirmDelete) {
    axios.delete(`http://localhost:2001/student/deleteStudent`, { data: email })
      .then((response) => {
  ...
  const handleSaveImage = () => {
    ...
    axios.put('http://localhost:2001/student/updateStudent', {
      ...updatedRow,
  ...
  const processRowUpdate = async (updatedRow) => {
    try {
      await axios.put(`http://localhost:2001/student/updateStudent`, updatedRow);
