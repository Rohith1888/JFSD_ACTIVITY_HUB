...
const ForgotPassword = () => {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      const response = await axios.post(
        'https://jfsdactivityhubbackend-production.up.railway.app/student/sendOtpforgot',
        email,
        {
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      const response = await axios.post('https://jfsdactivityhubbackend-production.up.railway.app/student/change', {
        email: email,
